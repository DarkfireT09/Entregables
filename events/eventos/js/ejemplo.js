...
//dos eventos y se ejecuten uno primero que el otro
...
function clic(){
	alert("ejecutado por el evento del boton")

}
function another_clic(){
	alert("ejecutado por el evento del div")
}
...
/*function informacion(elEvento) {
  ...
  switch(evento.type) {
    ...
    case 'keypress':
      ...
      muestraInformacion(['Teclado', 'Caracter ['+letra+']', 'Código ['+codigo+']']);
      break;
    case 'click':
